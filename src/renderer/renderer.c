...
static void record_shadow_pass(VulkanContext *vk, VkCommandBuffer cmd) {
    ...
    VkBuffer shadow_buffers[] = { vk->vertex_buffer_3d, vk->instance_buffer_3d };
    VkDeviceSize shadow_offsets[] = { 0, 0 };
    vkCmdBindVertexBuffers(cmd, 0, 2, shadow_buffers, shadow_offsets);
